    ...
    <main>
      ...
      <section className="mt-16 px-4 max-w-4xl mx-auto">
        ...
        <ul>
          ...
          <li>
            5. Serwis wykorzystuje dane osobowe w następujących celach: Obsługa
            zapytań przez formularz
          </li>
          <li>
            6. Serwis realizuje funkcje pozyskiwania informacji o użytkownikach
            i ich zachowaniu w następujący sposób: <br /> a. Poprzez dobrowolnie
            wprowadzone w formularzach dane, które zostają wprowadzone do
            systemów Operatora. <br /> b. Poprzez zapisywanie w urządzeniach
        ...
        <h2 className="text-2xl font-semibold mt-5">3. Hosting</h2>
        <p>
        ...
        <h2 className="text-2xl font-semibold mt-5">6. Logi Administratora</h2>
        <ol className="list-decimal pl-5">
          <li>
        ...
        <ol className="list-decimal pl-5">
          ...
          <li>
            ...
            instrukcjami: Edge, Internet Explorer, Chrome, Safari, Firefox,
            Opera. Urządzenia mobilne: Android, Safari (iOS), Windows Phone
          </li>
        </ol>
      </section>
    </main>
